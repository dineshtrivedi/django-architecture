...
class HelloWorld:
    ...
    # Why?
    # required=False seems to be complicated on the dataclass since in the serializer it means the data won't
    # necessary be there but for the dataclass to be instantiated successfully the data needs to be there unless
...
# When using many=True in a Serializer Generated by DataclassSerializer, the Optional Field (the id field in the
# example below)
